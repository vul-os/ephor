...
/// A `matcher` coordinator's posture for `pier_conformance::check` (CONTRACT §2/§4/§5/§6).
...
impl MatcherCoordinator {
    ...
    /// `pier_conformance::check` finding. Prefer [`MatcherCoordinator::signed`] for the common
