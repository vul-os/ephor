...
//!
//! Pier/KOTVA mints nothing. There is no protocol token anywhere in this crate, and
...
//! Pier-defined unit. Custody and canonical settlement of that asset are **entirely the rail
//! implementation's problem** — a real chain client, a card processor, a bank-transfer API — none
//! of which lives in this crate. Pier brokers none of it and takes no cut (DIRECTION §5,
//! CONTRACT §6).
//!
...
/// rail-agnostic (not a `pier_economics::UsageReceipt`; that is the *usage* receipt to the
...
pub struct PaymentRequired {
    ...
    pub amount: u64,
    /// An existing asset code (ISO 4217 or a stablecoin ticker) — never a Pier-defined unit.
    pub currency: String,
