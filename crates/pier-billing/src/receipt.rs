//! Usage receipts — issuing a signed [`pier_economics::UsageReceipt`] for a billed operation,
...
//!
//! `pier_economics::UsageReceipt::verify()` proves exactly one thing: **the coordinator really
...
use pier_economics::{Cbor, DescriptorError, IdentityKey, UsageReceipt};
...
/// The concrete shape carried inside a [`pier_economics::UsageReceipt::operation`] payload for
