...
//! coordinator's data plane is expected to call [`pier_billing::Meter::record`] directly
...
//! `pier_billing::receipt`'s module doc for the full disclosure (CONTRACT §6, R-6).
...
use pier_billing::{BilledOperation, TariffSchedule};
use pier_economics::UsageReceipt;
