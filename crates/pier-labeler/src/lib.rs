...
/// A `labeler` coordinator's posture for `pier_conformance::check` (CONTRACT §2/§4/§5/§6). See
...
impl LabelerCoordinator {
    ...
    /// `pier_conformance::check` finding. Prefer [`LabelerCoordinator::signed`] for the common
