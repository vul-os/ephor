...
/// A `compute` coordinator's posture for `pier_conformance::check` (CONTRACT §2/§4/§5/§6). Kept
...
impl ComputeCoordinator {
    ...
    /// `pier_conformance::check` finding. Prefer [`ComputeCoordinator::signed`] for the common
