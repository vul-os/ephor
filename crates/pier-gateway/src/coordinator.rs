...
//!
//! This is the one Pier kind that is **not** content-blind: the legacy SMTP leg is unavoidably
...
use pier_conformance::{Coordinator, Gate, LockIn, Metering, ScarceResource, SelfHost, Settlement};
...
use pier_economics::{Cbor, SignedDescriptor};
