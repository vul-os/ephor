...
- **Endpoint failover panel** — live status of the primary ↔ LAN probe cycle,
...
- **Architecture diagram** — an embedded SVG sequence diagram of the signaling
  + relay-fallback flow, rendered to a standalone PNG.

## Captured screenshots

![Demo harness overview](screenshots/hero.png)

Demo harness overview — endpoint failover and presence panels.

![Architecture / sequence diagram](screenshots/architecture.png)
