...
import { generateBoxKeyPair, sealRelayBlob, type BoxKeyPair } from '../relayBox.js'

export interface MakeRelayBlobArgs {
...
export interface MakeRelayBlobResult {
  blob_b64: string
  epk: string
  senderKP: BoxKeyPair
}
...
export function makeRelayBlob({ recipientBoxPubB64, to, from, session, data, senderKP }: MakeRelayBlobArgs): MakeRelayBlobResult {
