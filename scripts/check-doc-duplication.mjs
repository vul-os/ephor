...
const DECLARED_DIVERGENCE = {
  ...
  "screenshots.md":
    "The site copy embeds the PNGs inline and drops the docs/-relative path prefix, " +
    "because the site serves them from site/docs/screenshots/. It ALSO says " +
    '"primary <-> LAN" where docs/ and client/src/endpoints.js both say "cloud <-> LAN". ' +
    "That wording split is UNRESOLVED, not blessed: the site was de-branded and the " +
    "code was not. Recorded here so it is a visible open question rather than a " +
    "silent difference.",
};
