...
#     name as a regex — every "." in "relay-client-v1.2.3.tar.gz" is a wildcard
...
trap_sums = (line(ART + ".sig", OTHER) +
             line("relay-client-v9X9X9-dist.tar.gz", OTHER)).encode()
...
run_selftest() {
  ...
  local art="relay-client-v9.9.9-dist.tar.gz"
